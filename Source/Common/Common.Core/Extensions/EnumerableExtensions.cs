...
namespace Auxilia
{
    ...
    public static class EnumerableExtensions
    {
        ...
        public static IEnumerable<T> ThrowIfContainsNull<T>(this IEnumerable<T> source, string parameterName)
        {
...
#pragma warning restore ExceptionNotDocumented // Exception is not documented
        ...
        public static void Execute<T>(this IEnumerable<T> source, Action<T> action)
        {
            ...
            {
                throw new InvocationException("An error occurred while invoking the action.", exception);
            }
        }
    }
}
